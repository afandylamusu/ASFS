...
namespace System.Data.Entity
{
    ...
    public class PagedList<T> : IPagedList<T>
    {
        ...
        public bool HasPreviousPage { get {return PageIndex - IndexFrom > 0;}}

        /// <summary>
        /// Gets the has next page.
        /// </summary>
        /// <value>The has next page.</value>
        public bool HasNextPage { get {return PageIndex - IndexFrom + 1 < TotalPages; }}
        ...
        internal PagedList(IEnumerable<T> source, int pageIndex, int pageSize, int indexFrom)
        {
            ...
            {
                throw new ArgumentException(string.Format("indexFrom: {0} > pageIndex: {1}, must indexFrom <= pageIndex", indexFrom,pageIndex) );
            }
    ...
    public static class PagedList
    {
        ...
        public static IPagedList<T> Empty<T>() { return new PagedList<T>(); }
        /// <summary>
        ...
        public static IPagedList<TResult> From<TResult, TSource>(IPagedList<TSource> source, Func<IEnumerable<TSource>, IEnumerable<TResult>> converter) { return new PagedList<TSource, TResult>(source, converter); }
    }
}
