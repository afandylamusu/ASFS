...
namespace System.Data.Entity
{
    ...
    public class UnitOfWork<TContext> : IRepositoryFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        {
            if(context == null)
                throw new ArgumentNullException(typeof(TContext).Name);
        ...
        public IQueryable<TEntity> FromSql<TEntity>(string sql, params object[] parameters) where TEntity : class { return _context.Set<TEntity>().SqlQuery(sql, parameters).AsQueryable(); }
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    foreach (var unitOfWork in unitOfWorks)
                    {
                        ...
                        uow.DbContext.Database.UseTransaction(transaction.UnderlyingTransaction);
